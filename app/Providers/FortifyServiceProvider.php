...
use App\Responses\ConditionalLoginResponse;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    {
        // Conditional post-login redirect based on authenticated user's email / role.
        $this->app->singleton(LoginResponse::class, ConditionalLoginResponse::class);
    }
